 ...
 * Languages Model
 *
 * @property \App\Model\Table\ManifestationsTable&\Cake\ORM\Association\BelongsToMany $Manifestations
 *
...
class LanguagesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('Manifestations', [
            'foreignKey' => 'language_id',
            'targetForeignKey' => 'manifestation_id',

...
class Receiver extends Entity
{
     ...
     */
    public function _getReceiverName() {
    ...
    /**
     * Virtual Field for displaying the receiver (either a person or an institution) with details
     *
     * @return \Cake\ORM\Query
     */
    public function _getReceiverNameWithDetail() {
